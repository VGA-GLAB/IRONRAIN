...
namespace IronRain.Recording
{
    public class CustomRecorderController : MonoBehaviour
    {
        ...
        private UnityEditor.Recorder.RecorderController _controller;
        ...
        private void SetUpRecorderController()
        {
            ...
            // コントローラーを作成
            _controller = new UnityEditor.Recorder.RecorderController(_controllerSettings);
        }
